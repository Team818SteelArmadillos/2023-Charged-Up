...
public class BlueMiddleAuton extends SequentialCommandGroup {
  ...
  SwerveDrivetrain swerveDrivetrain, ClawSubsystem clawSubsystem, LEDSubsystem ledSubsystem) {
    ...
    addCommands(
      ...
      new WaitCommand(0.5),
      new ParallelCommandGroup(new ClawCommand(clawSubsystem, ledSubsystem), new WaitCommand(0.8)), //Dispenses cone
      new ArmAuton(armSubsystem, 3), //sets arm to neutral position
      new DriveDistance(swerveDrivetrain, 8.25, 0.7, 0.0, 1.0, true, true), //Drives to middle of field
      new WaitCommand(0.8),
