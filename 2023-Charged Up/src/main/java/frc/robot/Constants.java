...
public final class Constants {
    ...
    public static final double encoderOvershoot = 0.844444;
   ...
   /*============================
    ...
    //Pipeline Constants
    public static final int APRIL_TAG = 0;
    public static final int CUBE_DETECTION = 1;
    public static final int CONE_DETECTION = 2;
}