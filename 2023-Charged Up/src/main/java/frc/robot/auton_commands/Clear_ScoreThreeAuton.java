...
public class Clear_ScoreThreeAuton extends SequentialCommandGroup {
  ...
  public Clear_ScoreThreeAuton(String alliance, ArmSubsystem armSubsystem, ClawSubsystem clawSubsystem, CTRSwerveSubsystem swerveSubsystem, IntakeSubsystem intakeSubsystem) {
