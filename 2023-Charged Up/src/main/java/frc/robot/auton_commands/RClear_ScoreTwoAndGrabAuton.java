...
public class RClear_ScoreTwoAndGrabAuton extends SequentialCommandGroup {
  /** Creates a new IWantToWinAuton. */
  public RClear_ScoreTwoAndGrabAuton(ArmSubsystem armSubsystem, ClawSubsystem clawSubsystem, CTRSwerveSubsystem swerveSubsystem) {
