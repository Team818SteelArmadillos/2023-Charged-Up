...
public class BWire_ScoreTwoCrossAuton extends SequentialCommandGroup {
  /** Creates a new IWantToWinAuton. */
  public BWire_ScoreTwoCrossAuton(ArmSubsystem armSubsystem, ClawSubsystem clawSubsystem, CTRSwerveSubsystem swerveSubsystem) {
