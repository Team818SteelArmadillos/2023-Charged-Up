...
public class DriveToCenterOfPlatform extends CommandBase {
  ...
  public DriveToCenterOfPlatform(int direction, CTRSwerveSubsystem drivetrain) {
  ...
  public void initialize() {
    ...
    m_targetX = m_drivetrain.getCTRSwerveDrivetrain().getPoseMeters().getX() + (m_direction * 1.0);
    m_targetY = m_drivetrain.getCTRSwerveDrivetrain().getPoseMeters().getY();
    m_targetAngle = m_drivetrain.getCTRSwerveDrivetrain().getPoseMeters().getRotation();
