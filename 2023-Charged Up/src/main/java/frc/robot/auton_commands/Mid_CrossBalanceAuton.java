...
public class Mid_CrossBalanceAuton extends SequentialCommandGroup {
  public Mid_CrossBalanceAuton(ArmSubsystem armSubsystem, ClawSubsystem clawSubsystem, CTRSwerveSubsystem swerveSubsystem) {
    addCommands(
